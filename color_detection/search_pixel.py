...
def detect_color_range_and_label(image_path, lower_bounds, upper_bounds):
    ...
    gray_image = cv2.cvtColor(gray_image, cv2.COLOR_GRAY2BGR)  # Converter de volta para 3 canais para combinar com a máscara

    # Rotular os pixels encontrados como azul, mantendo o restante em escala de cinza
    labeled_image = gray_image.copy()
    labeled_image[mask != 0] = [255, 0, 0]  # BGR para Azul

    # Salvar a imagem de resultado
    output_image_path = "labeled_image_gray.jpg"
